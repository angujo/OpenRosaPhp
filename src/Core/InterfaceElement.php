 ...
 * @method Input InputDateMonthYear($name)
 * @method Input InputDateYear($name)
 ...
 * @method Range RangeVertical($name, int $starts, float $ends, float $step)
 * @method Range RangePicker($name, int $starts, float $ends, float $step)
 * @method Range RangeRating($name, int $starts, float $ends, float $step)
